...
import { DEFAULT_KNOWLEDGE_GRAPH_SETTINGS, type KnowledgeGraphSettings } from '../services/contentService';
...
const Dashboard: React.FC<DashboardProps> = ({ onSelectPart, onNavigateToNews, onNavigateToDiscussion, onNavigateToShop, onNavigateToMockExam, onNavigateToDailyEnglish, onNavigateToKnowledgeGraph, onNavigateToLeaderboard, showShopButton = false, showKnowledgeGraph = true, knowledgeGraphSettings = DEFAULT_KNOWLEDGE_GRAPH_SETTINGS }) => {
            ...
            <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <h4 className="text-2xl font-black tracking-tight text-white md:text-3xl">{knowledgeGraphSettings.title || DEFAULT_KNOWLEDGE_GRAPH_SETTINGS.title}</h4>
                  <p className="mt-1 max-w-2xl text-sm font-medium leading-6 text-slate-300">{knowledgeGraphSettings.subtitle || DEFAULT_KNOWLEDGE_GRAPH_SETTINGS.subtitle}</p>
                </div>
              </div>
              <span className="inline-flex w-fit items-center justify-center rounded-full bg-cyan-300 px-5 py-3 text-sm font-black text-slate-950 transition group-hover:bg-amber-300">
                {knowledgeGraphSettings.buttonLabel || DEFAULT_KNOWLEDGE_GRAPH_SETTINGS.buttonLabel}
              </span>
            </div>
          </button>
        )}
